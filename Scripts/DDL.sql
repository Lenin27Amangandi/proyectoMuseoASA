...
DROP TABLE IF EXISTS Administrador2;


CREATE TABLE
    Administrador2 (
        idAdministrador2 INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    INSERT INTO
        Administrador2 (Codigo, Usuario, Contrasenia, Tipo)
    VALUES
        ('1234567890111', 'lenin', 'lenin123', 1),
        ('1234567890123', 'andi', 'andi123', 2),
        ('1234567890124', 'joan', 'joan123', 2),
        ('1234567890125', 'antony', 'antony123', 2);
...
SET
    Estado = 'X',
    FechaModifica = datetime ('now', 'localtime')
WHERE
...
WHERE
    Estado = 'A'
    AND BarCode = "0234567890125";

UPDATE PiezaDeArte
SET
    Nombre = 'El Grito',
    Descripcion = 'Pintura expresionista',
    PrecioReplica = 15.00,
    FechaModifica = datetime ('now', 'localtime')
WHERE
...
UPDATE PiezaDeArte
SET
    Nombre = 'Noche Estrelladaaa',
    Autor = 'Vincent van Gogh',
    Descripcion = 'Pintura postimpresionista',
    PrecioReplica = 25.00,
    idCategoria = 1,
    idSeccion = 3,
    FechaModifica = datetime ('now', 'localtime')
WHERE
    BarCode = '0234567890125';
